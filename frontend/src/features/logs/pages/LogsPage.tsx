...
export default function LogsPage() {
  ...
  const data = [
    { id: 1, timestamp: '2026-06-15 14:23:45', type: 'error', component: 'Main Gate', message: 'Main gate servo did not move' },
    { id: 2, timestamp: '2026-06-15 14:10:18', type: 'error', component: 'Internal Gate', message: 'Internal gate servo did not move' },
    { id: 3, timestamp: '2026-06-15 13:42:09', type: 'error', component: 'Motor', message: 'Motor did not spin' },
    { id: 4, timestamp: '2026-06-15 13:25:31', type: 'error', component: 'Sensor', message: 'Sensor not detecting' },
    { id: 5, timestamp: '2026-06-15 12:00:10', type: 'info', component: 'System', message: 'Machine restarted' },
    { id: 6, timestamp: '2026-06-15 11:36:44', type: 'info', component: 'System', message: 'Machine turned off' },
  ];
